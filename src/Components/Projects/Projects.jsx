    ...
    <div id="projects">
      ...
      <div className="My_Projects">
        ...
        <div className="project-card">
          ...
          <div className="project-links">
            <button className="project-github-link" onClick={craftsGit}>
              GitHub
            </button>
            <button className="project-deployed-link" onClick={craftsDem}>
              Demo
            </button>
          </div>
        </div>
        <div className="project-card">
          <div className="project-image">
            <img
              src="https://www.linkpicture.com/q/Screenshot-804.png"
              alt="BeFour"
            />
          </div>
          <div className="project-title">
